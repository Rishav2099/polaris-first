...
import { useProject } from "../hooks/use-projects"; // Check your import path here
...
export const PreviewView = ({ projectId }: { projectId: Id<"projects"> }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-background">
      ...
      {/* BODY - FIXED ALLOTMENT */}
      <div className="flex-1 min-h-0">
        <Allotment vertical>
          {/* Top Pane: Browser Preview */}
          <Allotment.Pane>
            {error && (
          ...
          {/* FIX: Use the 'visible' prop instead of conditional rendering */}
          <Allotment.Pane
            minSize={100}
            maxSize={500}
            preferredSize={200}
