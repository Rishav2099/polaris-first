...
const Tab = ({
  ...
  return (
    <div
      ...
      className={cn(
        "flex items-center gap-2 h-8.75 pl-2 pr-2 cursor-pointer text-muted-foreground group border-y border-x border-transparent hover:bg-accent/30",
        isActive &&
          "bg-transparent text-foreground border-x-border border-b-background -mb-px drop-shadow-2xl",
