  ...
  return [
    {
      ...
      create() {
        ...
        dom.className =
          "bg-popover text-popover-foreground z-50 rounded-sm border border-input p-1 shadow-md flex item-center gap-2 text-sm";
        ...
        quickEditButton.className = "text-sm opacity-60";
